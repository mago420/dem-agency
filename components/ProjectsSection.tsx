...
const feedItems = [
  ...
  { type: 'image', src: '/deck/assets/case-actii-kmc-1m.jpg', label: 'KMC Brands', tag: '+1M Views', height: 'h-64 sm:h-80' },
  { type: 'image', src: '/deck/assets/case-coolbox-cup.jpg', label: 'Torneo Arena', tag: 'ESPORTS', height: 'h-72 sm:h-96' },
  ...
  { type: 'image', src: '/deck/assets/content-ama-cargador.jpg', label: 'AMA Jugos', tag: 'Pulpa', height: 'h-72 sm:h-96' },
  ...
  { type: 'image', src: '/deck/assets/content-ama-cargador.jpg', label: 'AMA Cargadores', tag: 'Producto', height: 'h-48 sm:h-64' },
  ...
  { type: 'image', src: '/deck/assets/content-snackpack.jpg', label: 'Snack Pack', tag: 'Social', height: 'h-48 sm:h-64' },
  ...
  { type: 'image', src: '/deck/assets/case-coolbox-cup.jpg', label: 'Coolbox Cup', tag: 'Esports', height: 'h-48 sm:h-64' },
